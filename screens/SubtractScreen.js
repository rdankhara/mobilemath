...
const SubtractScreen = ({ navigation }) => {
  ...
  const onAnswer = e => {
    ...
    if (all.length == 20) {
      navigation.navigate("Result", { param: { all, operation: "minus" } });
    } else {
      renderNext();
    }
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAwareScrollView style={styles.container} behavi>
        <View style={styles.mathContainer}>
          ...
          <MaterialCommunityIcons name="minus" size={100} />
...
SubtractScreen.navigationOptions = {
